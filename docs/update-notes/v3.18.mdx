---
description: Roo Code 3.18 introduces experimental codebase indexing, enhanced context condensing, YAML support for custom modes, and Gemini 2.5 Flash support.
keywords:
  - Roo Code 3.18
  - release notes
  - codebase indexing
