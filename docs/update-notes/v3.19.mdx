---
description: Roo Code 3.19 focuses on UI improvements with intelligent context condensing enabled by default, enhanced file protection, and experimental multi-file reading.
keywords:
  - Roo Code 3.19
  - release notes
  - context condensing
