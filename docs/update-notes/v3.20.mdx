---
description: Roo Code 3.20 introduces the experimental Marketplace for extensions and modes, concurrent file edits and reads, and prompt history navigation.
keywords:
  - Roo Code 3.20
  - release notes
  - marketplace
