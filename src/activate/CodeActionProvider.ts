...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with airiOS Code",
	FIX: "Fix with airiOS Code",
	IMPROVE: "Improve with airiOS Code",
	ADD_TO_CONTEXT: "Add to airiOS Code",
	NEW_TASK: "New airiOS Code Task",
} as const
