...
import {
	...
	DEFAULT_AUTO_CONDENSE_ON_MODEL_SWITCH,
	DEFAULT_AUTO_CONDENSE_MODEL_SWITCH_LOOKBACK,
	validateAutoCondenseModelSwitchLookback,
	getModelId,
	isRetiredProvider,
} from "@roo-code/types"
	...
	*/
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		const {
			...
			autoCondenseOnModelSwitch,
			autoCondenseModelSwitchLookback,
			soundEnabled,
			ttsEnabled,
			ttsSpeed,
			enableCheckpoints,
		...
		return {
			...
			autoCondenseOnModelSwitch: autoCondenseOnModelSwitch ?? DEFAULT_AUTO_CONDENSE_ON_MODEL_SWITCH,
			autoCondenseModelSwitchLookback: validateAutoCondenseModelSwitchLookback(autoCondenseModelSwitchLookback),
	...
	> {
		...
		return {
			...
			autoCondenseOnModelSwitch:
				stateValues.autoCondenseOnModelSwitch ?? DEFAULT_AUTO_CONDENSE_ON_MODEL_SWITCH,
			autoCondenseModelSwitchLookback: validateAutoCondenseModelSwitchLookback(
				stateValues.autoCondenseModelSwitchLookback,
			),
